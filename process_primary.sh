...
export PATH=~/Desktop/niftiiproject/DiffusionKitSetup-x86_64-v1.4-r161127/bin/:$PATH
export PATH=~/Desktop/niftiiproject/DiffusionKitSetup-x86_64-v1.4-r161127/lib/:$PATH
export PATH=~/Desktop/niftiiproject/sub01/:$PATH
for file in `cat ../data/list.txt`
do
    cd $file
    echo $file
